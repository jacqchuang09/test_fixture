...
# there toward the 41 mm maximum. A press is stopped if the actuator reaches
...
# 41 mm is the max extrusion this fixture allows, NOT the 50.8 mm datasheet
    ...
    def manual_force_move(self, target_force, direction="down", speed=None):
        ...
        try:
            ...
            while True:
                ...
                # and moves toward the 41 mm maximum, so only the max end is a limit
