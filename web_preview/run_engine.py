...
# there toward the 34 mm maximum. A press is stopped if the actuator reaches
...
# 34 mm is the max extrusion this fixture allows, NOT the 50.8 mm datasheet
# travel - the actuator is held back so it cannot drive into the fixture.
# Set these to match the actual stage if it differs.
ZABER_TRAVEL_MIN_MM = 17.0
ZABER_TRAVEL_MAX_MM = 34.0
    ...
    def manual_force_move(self, target_force, direction="down", speed=None):
        ...
        try:
            ...
            while True:
                ...
                # and moves toward the 34 mm maximum, so only the max end is a limit
