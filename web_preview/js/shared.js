 ...
 */
      ...
      // X-NA08A50-E09 actuator limits. 17 mm is the working baseline/home; 42 mm is the max extrusion
      // this fixture allows (25 mm from home; the datasheet travel is 50.8 mm, but the actuator is held
      // back so it cannot drive into the fixture). Keep this in sync with ZABER_TRAVEL_MAX_MM in run_engine.py.
      const ACTUATOR_MIN_MM = 17;
      const ACTUATOR_MAX_MM = 42;
