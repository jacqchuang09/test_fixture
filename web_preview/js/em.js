 ...
 */
      ...
      function drawEmForceGraph() {
        ...
        // Default view: the whole run (cumulative), force from 0. Scroll to zoom; the view
        // is clamped to the generated data so it can never scroll past what exists.
        ...
        const view = graphViewRange("emForceGraph", bounds, bounds);
        const color = "#3f73e6";
