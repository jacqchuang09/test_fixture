...
doc("3 - Technical Reference", [
  ...
  TABLE(["Field", "Range", "Notes"], [
    ...
    ["Fatigue frequency", "0.1 to 1 Hz", "a true square wave holds only up to ~0.25 Hz (see below)"],
  ...
  P([{ t: "The frequency field accepts " }, { t: "0.1 to 1 Hz", b: true }, { t: ". For a faithful square wave, keep it at or below " }, { t: "0.25 Hz", b: true, color: GREEN }, { t: "; above that the shape degrades to a rounded triangle, and above ~0.5 Hz it no longer reaches its bounds." }]),
